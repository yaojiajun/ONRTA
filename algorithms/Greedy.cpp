...
float p=0.05; //moving cost of worker
...
void Pure_Greedy(ifstream& fin, int seqN) {
    node_t node;
    vector<node_t> tasks, workers, workingworker,tworkingworker, temptasks, tempworkers;
    int taskId, workerId;
    node_t nd;
...
int main(int argc, char* argv[]) {
	...
	for(int i=0;i<100;i++){
	    edgeFileName.clear();
        //edgeFileName += "./data/synthetic2/tasks/500_2000_1_10_0.5_6_10/data_";
        //edgeFileName+="./data/scaleData1/syn1/10000_50000_1_10_0.5_6_10_0.5_3/data_" ;
        //edgeFileName += "./data/real/EverySender_cap1/800/data_80";
        edgeFileName += "./data/scaleData/syn2/10000_50000_2_10_0.5_6_10/data_";
        //edgeFileName += "./data/synthetic3/task/500_10000_1_10_0.5_6_10_0.5_3/data_";
        //edgeFileName += "./data/synthetic6/worker/500_2500_1_10_0.5_6_10_0.5_3/data_";
        edgeFileName+=to_string(static_cast<long long>(0));
        edgeFileName+=".txt"  ;
